...
var adcc="glob";
var enableBetaAds=!1;
var lastAdRequest=(new Date).getTime();
var adcnt=0;
var convcomp=!1;
var asecl=5;
var arell=4;
...
_loadAds=function(a)
{
	...
	adcnt+=1;
	var c=tstamp();
	b="http://edge.youtube-mp3.org/acode/"+adcc+"/rectangle.htm";
	d="http://edge.youtube-mp3.org/acode/"+adcc+"/skyscraper.htm";
	!0==a&&(b+="?r="+c;
	d+="?r="+c);
	cFrame("rad",300,250,b);
	cFrame("sad",160,600,d);
};
...
pushItemError=function()
{
	...
	g("error_text").innerHTML="<b>"+_ytmp3Lang.INVALID_URL+":</b><br />"+g("youtube-url").value;res();
};
